...
import type { AppChildrenProps, StatsContextValue, StatsState } from '../types/app';
...
export function StatsProvider({ children }: AppChildrenProps) {
  const { user } = useUser();
...
export const useStats = (): StatsContextValue => useContext(StatsContext);
